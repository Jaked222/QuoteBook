package com.example.jakeduncan.thequotebook;
...
import static com.example.jakeduncan.thequotebook.R.id.normal;
...
public class Quotebook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Quote quote5 = new Quote("I was gonna be the first person in my family to graduate " +
                "from community college. Everyone else graduated from normal college", "Troy Barnes");
        quoteList.add(quote5);

        Quote quote6 = new Quote("Sadie's birthday is today. Everyone get ready for some partay time.", "Jake D");
